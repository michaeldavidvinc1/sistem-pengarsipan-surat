...
class SuratKeluarController extends Controller
{
        ...
        if ($request->ajax()) {
            ...
            return datatables()::of($suratKeluar)
                ...
                ->addColumn('action', function ($row) {
                    $btnEdit  = '<a href="'.route('suratKeluar.edit', $row->id).'" class="edit btn btn-primary btn-sm">Edit</a>';
    ...
    public function create(){
        $petugas = Petugas::all();
        return view('admin.surat_keluar.create', compact('petugas'));
    }
    ...
    public function edit($id){
        ...
        $petugas = Petugas::all();
        return view('admin.surat_keluar.edit', compact('data', 'petugas'));
    }
