        ...
        <div class="row">
            <div class="col-12 mt-4">
                <div class="card rounded shadow">
                    <div class="p-4">
                        <a href="{{ route('petugas.suratKeluar.index') }}" class="btn btn-primary btn-sm">Kembali</a>
                    </div>
                    <div class="p-4">
                        <form action="{{ route('petugas.suratKeluar.update', $data->id) }}" method="POST"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="form-icon position-relative">
                                            <input type="text" name="yang_menandatangani" id="yang_menandatangani"
                                                value="{{ $data->yang_menandatangani }}" class="form-control"
                                                placeholder="Yang Menandatangani..." required>
