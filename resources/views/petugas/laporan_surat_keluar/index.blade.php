        ...
        <script>
            $(document).ready(function() {
                ...
                let table = new DataTable('#tableLaporanSuratMasuk', {
                    ...
                    autoWidth: false,
                    ajax: {
                        url: "{{ route('petugas.laporanSuratKeluar.index') }}",
                        data: function(d) {
                    ...
                    columns: [{
                        ...
                        },
                        {
                            data: function(data) {
                                let file = data.id;
                                let url = "{{ route('petugas.laporansuratKeluar.preview', ':file') }}"
                                    .replace(
                                        ':file',
                                        file);
                ...
                $('#cetak').click(function(e) {
                    ...
                    let url = "{{ route('petugas.laporanSuratKeluar.pdf') }}";
                ...
                $('#bulanIni').click(function(e) {
                    ...
                    let url = "{{ route('petugas.bulanIniKeluar.pdf') }}";
                ...
                $('#mingguIni').click(function(e) {
                    ...
                    let url = "{{ route('petugas.mingguIniKeluar.pdf') }}";
                ...
                $('#hariIni').click(function(e) {
                    ...
                    let url = "{{ route('petugas.hariIniKeluar.pdf') }}";
                ...
                $('#bulanKemarin').click(function(e) {
                    ...
                    let url = "{{ route('petugas.bulanKemarinKeluar.pdf') }}";
                ...
                $('#kemarin').click(function(e) {
                    ...
                    let url = "{{ route('petugas.kemarinKeluar.pdf') }}";
