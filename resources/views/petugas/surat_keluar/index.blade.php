        ...
        <div class="row">
            <div class="col-12 mt-4">
                <div class="card rounded shadow">
                    <div class="p-4">
                        <div class="mb-3">
                            <a href="{{ route('petugas.suratKeluar.create') }}" class="btn btn-primary btn-sm">Input Data</a>
        ...
        <script>
            $(document).ready(function() {
                ...
                let table = new DataTable('#tableSuratKeluar', {
                    ...
                    autoWidth: false,
                    ajax: {
                        url: "{{ route('petugas.suratKeluar.index') }}",
                        data: function(d) {
                    ...
                    columns: [{
                        ...
                        },
                        {
                            data: function(data) {
                                let file = data.id;
                                let url = "{{ route('petugas.suratKeluar.preview', ':file') }}".replace(
                                    ':file',
                                    file);
                ...
                $("#deleteButton").on("click", function(e) {
                    ...
                    $.ajax({
                        url: "{{ route('petugas.suratKeluar.destroy') }}",
                        type: 'DELETE',
                        data: {
